...
<!-- body -->
<div class="row">
    <div class="col s12 m10 offset-m1 card"> <!-- Card Induk -->
        <div class="card-content">
            <h3 class="header center">Loket Teller</h3> <!-- Judul Utama untuk Loket Teller -->
            <div class="row">
                <div class="col s12 m6">
                    <h4 class="header center">Loket Teller A</h4>
                    <form action="" method="post">
                        <div class="center">
                            <button class="btn-large blue darken-2" type="submit" name="panggilAntrianA">Panggil</button>
                ...
                <div class="col s12 m6">
                    <h4 class="header center">Loket Teller B</h4>
                    <form action="" method="post">
                        <div class="center">
                            <button class="btn-large blue darken-2" type="submit" name="panggilAntrianB">Panggil</button>
                ...
                <div class="col s12 m6">
                    <h4 class="header center">Loket Teller C</h4>
                    <form action="" method="post">
                        <div class="center">
                            <button class="btn-large blue darken-2" type="submit" name="panggilAntrianC">Panggil</button>
